"""
TBattleGenerator: Generates a battle map from map blocks according to a script.

Creates battle maps using terrain's map blocks and a map script, following the XCOM/OpenXcom map generation approach. Handles block grid setup, map assembly, validation, and export.

Classes:
    TBattleGenerator: Main class for battle map generation.
...
from engine.battle.battle_script import TBattleScript
