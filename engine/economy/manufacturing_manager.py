"""
manufacturing_manager.py

Defines the ManufacturingManager class, which manages active manufacturing projects and workshop capacity. Handles starting projects, daily progress, and resource management.

Classes:
    ManufacturingManager: Active manufacturing project and workshop manager.
