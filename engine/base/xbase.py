...
Defines the TBaseXCom class, representing an XCOM base on the world map, with facilities, inventory, and management methods. Handles facility management, inventory, and base serialization for XCOM bases.

Classes:
    TBaseXCom: XCOM base location, facility, and inventory management.
