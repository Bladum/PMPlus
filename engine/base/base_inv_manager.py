...
Defines the TBaseInventory class, which provides comprehensive inventory management for XCOM bases. Handles items, units, and crafts with categorized storage, addition, removal, and sorting operations.

Classes:
    TBaseInventory: Inventory management system for XCOM bases.
...
class TBaseInventory:
    ...
    Attributes:
        items (Dict[str, float]): Item ID to quantity mapping.
        units (List[TUnit]): Units stationed at the base.
        crafts (List[TCraft]): Crafts stationed at the base.
        item_categories (Dict[str, EUnitItemCategory]): Item ID to category mapping.
        storage_capacity (int): Maximum item storage capacity in size units.
        craft_capacity (int): Maximum number of crafts that can be stored at the base.
        item_sizes (Dict[str, float]): Item ID to size value mapping.
    """
    ...
    def __init__(self, storage_capacity: int = 100, craft_capacity: int = 4):
        ...
        Args:
            storage_capacity (int): Maximum storage capacity for items (default: 100)
            craft_capacity (int): Maximum number of crafts that can be stored (default: 4)
        """
    ...
    def add_item(self, item_id: str, quantity: float = 1.0, category: Optional[EUnitItemCategory] = None) -> bool:
        ...
        Args:
            ...
            quantity (float): Amount to add (can be fractional for certain resources)
            category (Optional[EUnitItemCategory]): Item category for classification (only set when adding new items)

        Returns:
            bool: True if successfully added, False if insufficient storage capacity
        """
    ...
    def remove_item(self, item_id: str, quantity: float = 1.0) -> bool:
        ...
        Returns:
            bool: True if successful, False if not enough items available
        """
    ...
    def set_item_quantity(self, item_id: str, quantity: float, category: Optional[EUnitItemCategory] = None) -> bool:
        ...
        Args:
            item_id (str): Unique identifier for the item
            quantity (float): Exact quantity to set
            category (Optional[EUnitItemCategory]): Item category if adding new item

        Returns:
            bool: True if successfully set, False if insufficient storage capacity
        """
        if quantity <= 0:
    ...
    def get_item_quantity(self, item_id: str) -> float:
        ...
        Returns:
            float: Current quantity of item, 0 if item doesn't exist
        """
    ...
    def get_item_category(self, item_id: str) -> Optional[EUnitItemCategory]:
        ...
        Returns:
            Optional[EUnitItemCategory]: ItemCategory of the item, None if item doesn't exist
        """
    ...
    def set_item_category(self, item_id: str, category: EUnitItemCategory) -> bool:
        ...
        Args:
            item_id (str): Unique identifier for the item
            category (EUnitItemCategory): New category for the item

        Returns:
            bool: True if successful, False if item doesn't exist
        """
    ...
    def get_items_by_category(self, category: EUnitItemCategory) -> Dict[str, float]:
        ...
        Args:
            category (EUnitItemCategory): Category to filter by

        Returns:
            Dict[str, float]: Dictionary of item_id -> quantity for matching items
        """
        return {
    ...
    def get_unique_items_count(self) -> int:
        ...
        Returns:
            int: Count of unique item types in inventory
        """
    ...
    def has_sufficient_items(self, required_items: Dict[str, float]) -> bool:
        ...
        Args:
            required_items (Dict[str, float]): Dictionary mapping item IDs to required quantities
    ...
    def consume_items(self, items_to_consume: Dict[str, float]) -> bool:
        ...
        Args:
            items_to_consume (Dict[str, float]): Dictionary mapping item IDs to quantities to consume

        Returns:
            bool: True if successful, False if not enough of any item
        """
    ...
    def set_item_size(self, item_id: str, size: float) -> None:
        ...
        Args:
            item_id (str): Unique identifier for the item
            size (float): Space taken by one unit of the item
        """
    ...
    def get_item_size(self, item_id: str) -> float:
        ...
        Returns:
            float: Size of the item, defaults to 1.0 if not specified
        """
    ...
    def get_used_storage(self) -> float:
        ...
        Returns:
            float: Total storage space used by all items
        """
    ...
    def get_remaining_storage(self) -> float:
        ...
        Returns:
            float: Remaining storage capacity
        """
    ...
    def remove_unit(self, unit: TUnit) -> bool:
        ...
        Args:
            unit (TUnit): Unit to remove

        Returns:
            bool: True if unit was found and removed, False otherwise
        """
    ...
    def get_units_by_type(self, unit_type: str) -> List[TUnit]:
        ...
        Args:
            unit_type (str): Type identifier to filter by

        Returns:
            List[TUnit]: List of matching units
        """
    ...
    def add_craft(self, craft: TCraft) -> bool:
        ...
        Args:
            craft (TCraft): Craft to add

        Returns:
            bool: True if successfully added, False if no capacity available
        """
    ...
    def remove_craft(self, craft: TCraft) -> bool:
        ...
        Args:
            craft (TCraft): Craft to remove

        Returns:
            bool: True if craft was found and removed, False otherwise
        """
    ...
    def get_crafts_by_type(self, craft_type: str) -> List[TCraft]:
        ...
        Args:
            craft_type (str): Type identifier to filter by

        Returns:
            List[TCraft]: List of matching crafts
        """
    ...
    def remove_capture(self, capture_id: str, quantity: float = 1.0) -> bool:
        ...
        Returns:
            bool: True if successful, False if not enough captures available
        """
    ...
    def get_capture_quantity(self, capture_id: str) -> float:
        ...
        Returns:
            float: Current quantity, 0 if not found
        """
    ...
    def save_template(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: Dictionary representing the current items, units, crafts, and captures.
        """
        return {
    ...
    def load_template(self, template: Dict[str, Any], unit_provider=None, craft_provider=None) -> None:
        ...
        Args:
            template (Dict[str, Any]): Dictionary representing items, units, crafts, and captures.
